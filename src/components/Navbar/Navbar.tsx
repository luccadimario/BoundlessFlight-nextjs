...
export default function Navbar(properties: NavbarProps):ReactElement {
    ...
    const redirectToSignIn = () => {
        window.location.href = "https://127.0.0.1:8000/connect/auth0";
    }
                ...
                <div className="ml-4 flex-1" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                    <div className="text-gray-200">
                        ...
                        <span className={"hidden md:inline-block text-xl"}>
                            <span className={`inline-block transition-transform duration-300 ease-in-out ${isHovered ? "translate-x-1" : ""}`}>
                            ...
                            <span className={`ml-4 font-light transition-opacity duration-300 ease-in-out ${isHovered ? "opacity-100" : "opacity-0"}`}>
                                {renderRoutes()}
                            </span>
                        </span>
